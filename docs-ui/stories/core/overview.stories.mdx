...
<DoDont doBox={doDontContent.do} dontBox={doDontContent.dont} />

👋 Hello there! <ColorChip value="#FFF" /> You've arrived at Sentry's UI System guidebook. <ColorChip value="#1A1A1A" /> Here, you will find a detailed account of our UI system, including interactive examples and recommended use cases. We want to have appropriate and consistent use of our components, so that's why this guidebook exists!
